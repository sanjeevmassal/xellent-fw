...
class Route {
	...
	protected $pattern, $dispatch = array (), $wildcard = false, $parts = array (), $regex;
	protected $url, $wildcardArgs = array ();
	
	/**
	 *
	 * @param string $pattern
	 *        	The pattern for the route.
	 ...
	 *        	Default values for the dispatcher.
	...
	/**
	 * Access any value directly as property.
	 * Will return dispatch values and wildcard arguments.
	 ...
	 *
	 * @param mixed $name
	 *        	Name of the named argument or index of unnamed argument.
	...
	/**
	 * Set a dispatch value or wildcard value.
	 * If the value is not specified in the pattern, it will be set as wildcard value.
	 ...
	 *
	 * @param string $part
	 *        	A single part without leading or trailing slash.
	 ...
	 *
	 * @param string $name
	 *        	Name of the part, i.e. key from $this->parts.
	 * @param mixed $value
